  ...
  return (
    <div id="draft-editor" className="editor">
      <div className="header-container">
        <h3 className="heading flex-1">Demo Editor by Aditya Singh</h3>
      ...
      <Editor
        ...
        placeholder={`Type # at the start of a line and pressing space creates a heading.\nType * at the start of a line and pressing space makes the text bold.\nType ** at the start of a line and pressing space makes the text red.\nType *** at the start of a line and pressing space makes the text underlined.`}
      />
    </div>
  );
};
